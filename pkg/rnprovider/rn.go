...
func NewMockProviderMockConfig(nodeName, operatingSystem string, internalIP string, daemonEndpointPort int32) (*MockProvider, error) {
...
func NewMockProvider(nodeName, operatingSystem string, internalIP string, daemonEndpointPort int32) (*MockProvider, error) {
	return NewMockProviderMockConfig(nodeName, operatingSystem, internalIP, daemonEndpointPort)
}
